# Product Guide: ILIN (Intelligent Document Processing & RAG System)

## Target Audience
- **Standard Users**: End users who interact with the system to submit documents and query the Retrieval-Augmented Generation (RAG) system for answers.

## Core Value
- **Information Retrieval**: The primary value is providing fast, accurate, and context-aware answers based on user-uploaded documents, leveraging advanced RAG techniques.
